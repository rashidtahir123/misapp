                    ...
                    <Body>
                      <Grid>
                        <Col>
                            ...
                            <Text style={[styles.detailText, {height:40}]}>{this.state.approvalData.approvalStatus}</Text>
                            <Text style={[styles.detailHeading, {height:25}]} >Approval Date:</Text>
                            <Text style={[styles.detailText, {height:40}]}>{this.state.approvalData.approveDate}</Text>
                            <Text style={[styles.detailHeading, {height:25}]} >{this.state.approvalData.approvebyTitle}:</Text>
                            <Text style={[styles.detailText, {height:40}]}>{this.state.approvalData.managerName}</Text>
                            <Text style={[styles.detailHeading, {height:25}]} >Comments:</Text>
                            <Text style={[styles.detailText, {height:40}]}>{this.state.approvalData.approveComments}</Text>
                          </Col>
                      </Grid>
                    </Body>
                  </CardItem>
