      ...
      <ImageBackground style={{width:'100%',height:100}}  source={require("../images/content-header.png")}>
          ...
          <Grid>
                ...
                <Col style={styles.colmargin}>
                    <TouchableHighlight style={{paddingTop:40}}
                        ...
                        <View style={styles.columnviewCenter}>
                              <Image style={{width: '100%', height: 140}}  resizeMode="cover" source={require('../images/addmaintenance.png')} />
                        </View>
                    </TouchableHighlight>
                </Col>
            ...
            <Row  style={{ height: 160}} >
                ...
                <Col style={styles.colmargin}>
                    <TouchableHighlight style={{paddingTop:40}}
                                onPress={this.maintenancelisting}  >
                        <View style={styles.columnviewCenter}>
                              <Image style={{width: '100%', height: 140}}  resizeMode="cover" source={require('../images/mymaintenance.png')} />
                        </View>
                    </TouchableHighlight>
                </Col>
            </Row>
