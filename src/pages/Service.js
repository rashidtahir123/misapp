                ...
                <Col style={styles.colmargin}>
                    <TouchableHighlight style={{paddingTop:40}}
                        ...
                        <View style={styles.columnviewCenter}>
                              <Image style={{width: "100%", height: 140}}  resizeMode="cover" source={require('../images/addservice.png')} />
                        </View>
                    </TouchableHighlight>
                </Col>
            ...
            <Row  style={{ height: 160}} >
                ...
                <Col style={styles.colmargin}>
                    <TouchableHighlight style={{paddingTop:40}}
                        ...
                        <View style={styles.columnviewCenter}>
                              <Image style={{width: '100%', height: 140}}  resizeMode="cover" source={require('../images/myservice.png')} />
                        </View>
                    </TouchableHighlight>
                </Col>
            </Row>
